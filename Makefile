...
app-create app-run dingding-robot git-checkout assert jsonparse redis-cli mysql-cli git-push release dice dice-deploy dice-deploy-addon dice-deploy-service dice-deploy-domain dice-deploy-release dice-deploy-redeploy dice-deploy-rollback \
